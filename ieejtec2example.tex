...
%
% 論文番号（1頁目右上にあるやつ）
\articlenumber{XXX-XX-XXX \par YYY-YY-YYY}
%
% 日本語タイトル
...
\jauthor{電子　太郎\authorstar\jauthordelim 電子　二郎（日本電機大学）\par 電子　三郎\jauthordelim 電子　四郎（日本電力）}
\eauthor{Taro Denshi\authorstar, Jiro Denshi (Nihon Denki University)\par Saburo Denshi, Shiro Denshi (Nihon Electric Power Company)}
%
\authorlist{%
